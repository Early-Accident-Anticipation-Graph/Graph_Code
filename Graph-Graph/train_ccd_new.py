...
parser.add_argument("--dataset_path", type=str, default="data/ccd/obj_feat", help="Path to extracted objects data")
parser.add_argument("--img_dataset_path", type=str, default="data/ccd/i3d_feat", help="Path to I3D feature data")
parser.add_argument("--obj_mapping_file", type=str, default="data/ccd/obj_idx_to_labels.json", help="path to object label mapping file")
parser.add_argument("--split_path", type=str, default="splits_ccd_new/", help="Path to train/test split")
...
def test_model(epoch, model, test_dataloader):
	...
	for batch_i, (X, edge_index, y_true, img_feat, video_adj_list, edge_embeddings, temporal_adj_list, obj_vis_feat, batch_vec, toa) in enumerate(test_dataloader):
		...
		print('video_adj_list.dtype')
		print(video_adj_list.dtype)
		print(video_adj_list.shape)
		print('edge_embeddings.dtype')
		print(edge_embeddings.dtype)
		print(edge_embeddings.shape)
		print('temporal_adj_list.dtype')
		print(temporal_adj_list.dtype)
		print(temporal_adj_list.shape)
		print('temporal_edge_w.dtype')
		print(temporal_edge_w.dtype)
		print(temporal_edge_w.shape)
		print('batch_vec.dtype')
		print(batch_vec.dtype)
		...
		print('all_y_vid.numpy()---------------------------------')
		print(all_probs_vid2.numpy().shape)
		print(all_probs_vid2.numpy().shape)
		print(all_y_vid.numpy())
		print('all_y_vid.numpy()---------------------------------')
